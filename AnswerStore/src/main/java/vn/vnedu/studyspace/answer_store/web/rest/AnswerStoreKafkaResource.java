...
@RestController
@RequestMapping("/api/answer-store-kafka")
public class AnswerStoreKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AnswerStoreKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public AnswerStoreKafkaResource(KafkaProperties kafkaProperties) {
