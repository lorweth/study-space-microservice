...
import vn.vnedu.studyspace.exam_store.service.TopicService;
...
/**
 * REST controller for managing {@link vn.vnedu.studyspace.exam_store.domain.Topic}.
 */
@RestController
@RequestMapping("/api")
public class TopicResource {
    ...
    private static final String ENTITY_NAME = "examStoreTopic";
