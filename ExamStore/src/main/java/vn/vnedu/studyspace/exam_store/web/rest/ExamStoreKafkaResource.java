...
@RestController
@RequestMapping("/api/exam-store-kafka")
public class ExamStoreKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ExamStoreKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ExamStoreKafkaResource(KafkaProperties kafkaProperties) {
