...
import vn.vnedu.studyspace.exam_store.service.OptionService;
...
/**
 * REST controller for managing {@link vn.vnedu.studyspace.exam_store.domain.Option}.
 */
@RestController
@RequestMapping("/api")
public class OptionResource {
    ...
    private static final String ENTITY_NAME = "examStoreOption";
