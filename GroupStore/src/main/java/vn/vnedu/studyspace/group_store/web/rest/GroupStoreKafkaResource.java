...
@RestController
@RequestMapping("/api/group-store-kafka")
public class GroupStoreKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GroupStoreKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GroupStoreKafkaResource(KafkaProperties kafkaProperties) {
