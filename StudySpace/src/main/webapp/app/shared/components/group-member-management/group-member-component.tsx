...
import { getEntities, getAllAdmins, getAllMembers, getAllWaitings } from 'app/entities/GroupStore/group-member/group-member.reducer';
...
const GroupMemberComponent = (props: RouteComponentProps<{ url: string }>) => {
  const dispatch = useAppDispatch();

  const [selectedRole, setSelectedRole] = useState(ROLES.WAITING);
