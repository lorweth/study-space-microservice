...
export const GroupMember = (props: RouteComponentProps<{ url: string }>) => {
      ...
      <h2 id="group-member-heading" data-cy="GroupMemberHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="studySpaceApp.groupStoreGroupMember.home.createLabel">Create new Group Member</Translate>
          </Link>
        </div>
      </h2>
