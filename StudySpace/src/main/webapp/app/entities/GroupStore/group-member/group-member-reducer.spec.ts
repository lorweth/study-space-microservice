...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPMEMBER_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPMEMBER actions', async () => {
      const expectedActions = [
        {
