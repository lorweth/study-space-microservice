...
export const GroupDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="studySpaceApp.groupStoreGroup.delete.question">
        <Translate contentKey="studySpaceApp.groupStoreGroup.delete.question" interpolate={{ id: groupEntity.id }}>
