...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './exam-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXAMITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXAMITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXAMITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXAMITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXAMITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXAMITEM actions', async () => {
      const expectedActions = [
        {
