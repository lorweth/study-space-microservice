...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONGROUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUESTIONGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUESTIONGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUESTIONGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUESTIONGROUP actions', async () => {
      const expectedActions = [
        {
