...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './answer-sheet-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANSWERSHEETITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANSWERSHEETITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANSWERSHEETITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANSWERSHEETITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANSWERSHEETITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANSWERSHEETITEM actions', async () => {
      const expectedActions = [
        {
