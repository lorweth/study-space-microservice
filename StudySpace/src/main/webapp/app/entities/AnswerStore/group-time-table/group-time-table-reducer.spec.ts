...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPTIMETABLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPTIMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPTIMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPTIMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPTIMETABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPTIMETABLE actions', async () => {
      const expectedActions = [
        {
