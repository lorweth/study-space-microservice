...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANSWERSHEET_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANSWERSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANSWERSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANSWERSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANSWERSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANSWERSHEET actions', async () => {
      const expectedActions = [
        {
