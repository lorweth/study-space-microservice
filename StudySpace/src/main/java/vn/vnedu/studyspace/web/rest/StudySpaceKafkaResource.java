...
@RestController
@RequestMapping("/api/study-space-kafka")
public class StudySpaceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(StudySpaceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public StudySpaceKafkaResource(KafkaProperties kafkaProperties) {
